...
class BookingViewSetTestCase(APITestCase):
    def setUp(self) -> None:
        ...
        self.booking1 = Booking.objects.create(
            name="John Doe", number_of_guests=2, booking_date=timezone.now()
        )
        self.booking2 = Booking.objects.create(
            name="Jane Smith", number_of_guests=4, booking_date=timezone.now()
        )
        self.valid_payload = {
            "name": "Test Booking",
            "number_of_guests": 3,
        ...
        self.invalid_payload = {"name": "", "number_of_guests": "", "booking_date": ""}
